...
由此可以总结出规律，offset 代表偏移量，如果偏移量是 n ，则显示的电影序号就是 n+1 到 n+10，每页显示10个。

所以想获取TOP100的电影，只需要分开请求10次，而10次的 offset 参数分别设置设置为 0、10、20···90即可，这样获取不同的页面之后，再用正则表达式提取出相关的信息，就可以得到TOP100的所有电影信息了。
